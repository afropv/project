...
app = Flask(__name__)
app.config['SECRET_KEY']= 'question'
client = MongoClient("mongodb://afropv:afropv1@ds121413.mlab.com:21413/afropv")
db = client['afropv']
users = db.users
	...
	if request.method == 'POST':
		...
		if search:
			...
			if authu == form.username.data and authp == form.password.data:
				...
				return redirect(url_for('braniac', name=authu))
